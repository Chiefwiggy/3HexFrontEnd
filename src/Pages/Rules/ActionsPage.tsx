...
const ActionsPage = ({}: IActionsPageInput) => {
    ...
    const actionsContent: Array<IActionContent> = [
        {
            actionName: "Equip",
                    ...
                    ["standard", "interaction", "free", "special"].map((actionType) => {
                        return (
                            <Box>
                                ...
                                {
                                    actionsContent.filter(e => e.actionType == actionType).sort((a,b) =>{
                                        ...
                                        return (
                                            ...
                                            >
                                                <BannerTitle idTag={action.actionName.split(" ").join("_").toLowerCase()} title={action.actionName} subtitle={`${actionType.toUpperCase()} ACTION - ${action.actionCategory.toUpperCase()}`} bannerColor={GetActionBannerColors(action.actionType) } >
                                                    {
