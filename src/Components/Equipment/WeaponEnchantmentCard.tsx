                ...
                >
                    <Box>
                        ...
                        <Typography variant={"subtitle2"} sx={{
                            color: "darkgray"
                        }}>{ getWeaponAffinityRequirement(weaponData.weaponClass, weaponMetadata.enchantmentLevel, weaponData.handedness, weaponData.damageType, weaponData.isCreatureWeapon, currentSheet.isUnlocked("ironGrasp"), currentSheet.getAbilityBonuses("weaponPrestigeRequirement"), false)}</Typography>
                        <Typography variant={"subtitle2"} sx={{
                            color: "darkgray"
