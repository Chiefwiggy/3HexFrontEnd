                    ...
                    isDetailedPage ?
                        ...
                        >
                            <Box>
                                ...
                                <Typography fontSize={14} color={"grey"} textAlign={"center"}>Warrior {weaponMetadata.enchantmentLevel} • {weaponData.damageType == "magical" ? "Presence" : "Skill"} {ScaleChainNumeric(weaponData.skillRequirement, weaponMetadata.enchantmentLevel)}</Typography>
                            </Box>
                            <Box
                                sx={{
                                    display: "grid",
                        ...
                        >
                            ...
                            <Typography variant={"body2"}>{currentSheet.getHandedness(weaponData.weaponClass, weaponData.handedness, weaponMetadata.enchantmentLevel)} • Warrior {weaponMetadata.enchantmentLevel} </Typography>
